    ...
    <div class="container">
      ...
      <div class="footer-content">
        ...
        <div class="footer-section">
          <h4>Контакты</h4>
          <div class="line"></div>
          <p>г. Москва, ул. Табачная, 15</p>
          <p>Email: info@premiumcigars.ru</p>
          <p>+7 (905) 735-35-80</p>
        </div>
      ...
      <div class="footer-section_info">
        <p>
          ...
          совершеннолетнего возраста. Компания Premim-Cigars не осуществляет дистанционную продажи
          алкогольной, табачной продукции, зажигалок и устройств для курения табака. Мы не продаем
          табачные изделия, устройства для курения и зажигалки лицам моложе 18 лет.
        </p>
      </div>
      <!-- Нижняя полоса -->
      <div class="footer-bottom">
        <p>&copy; 2025 Premium Cigars. Все права защищены.</p>
        <span>Сделано с уважением к искусству курения</span>
      </div>
